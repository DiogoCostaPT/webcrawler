...
%{
% Permafrost 2
folder_name_to_store_results = 'permafrost_AND_climate_change_TITLE-ABS-KEY_SCOPUS_2';                
main_keyword_searchengine_raw_multiple =[...
                                     'DOCTYPE(ar)',...
                                     ' AND TITLE-ABS-KEY(',...     
                                            '(permafrost*)',...
                                            ...
                                            ' AND NOT (',...
                                                       'methane OR hydrates OR quaternary OR pleistocene OR mars OR carbon-dioxide',...
                                                       'holocene OR radiocarbon OR "black spruce" OR glacier OR "rock glacier" OR geophysic* OR antarctic*',...
                                                      ')',...
                                       ')',...
...
%{
% Permafrost 3
folder_name_to_store_results = 'permafrost_AND_climate_change_TITLE-ABS-KEY_SCOPUS_3';                
main_keyword_searchengine_raw_multiple =[...
                                     'DOCTYPE(ar)',...
                                     ' AND SRCTYPE(j)',...
                                     ...' AND PUBYEAR > 2009',...
...
main_keyword_searchengine_raw_multiple =[...
                                    ...
                                    ' AND TITLE-ABS-KEY(',...     
                                     ...' AND TITLE(',...     
                                            '(permafrost*)',...
                                            ' AND (',...
                                                '*aquatic* OR **water OR *hydrolog* OR *groundwater OR *lake* OR *river* OR *creek* OR *bay* OR *stream*'...
                                                ' OR *basin* OR *watershed* OR *catchment* OR *drainage*',...
                                                ' OR *runoff* OR *flow* OR *discharge*',...
                                                ' OR *chemistry* OR *carbon* OR *nutrient* OR “water quality”',...
                                                ' OR model* OR simulat*',...
                                             ')',...
                                            ' AND NOT (',...
                                                       'methane OR hydrates OR quaternary OR pleistocene OR mars OR carbon-dioxide',...
