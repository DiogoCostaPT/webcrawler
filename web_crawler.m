...
main_keyword_searchengine_raw_multiple ={['TITLE-ABS-KEY(',...
                                        '("climat* *chang*" OR "global warming")',...
                                        ' AND (nutrient* OR nitrogen* OR *phosph* OR nitrat*)',...
                                        ' AND (river* OR lake* OR wetland OR stream* OR basin* OR watershed*)',...
                                        ' AND NOT ("greenhouse gas*" OR emissions OR methane OR "carbon dioxide")',...
